...
public class UserRememberMeServices extends PersistentTokenBasedRememberMeServices {
    ...
    public UserRememberMeServices(String key, UserDetailsService userDetailsService, PersistentTokenRepository tokenRepository) {
