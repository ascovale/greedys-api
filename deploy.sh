...
# Initialize swarm if not already active (specify advertise-addr to handle multiple IPs)
docker swarm init --advertise-addr 46.101.209.92 2>/dev/null || echo "Swarm already active"
